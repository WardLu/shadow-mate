...
values
  ('84000000-0000-4000-8000-000000000001', 'shadow-mate', 'sync_failed', '82000000-0000-4000-8000-000000000001', '83000000-0000-4000-8000-000000000001', now() - interval '179 days', 'Asia/Shanghai', '{"error_code":"net"}'::jsonb, 'cleanup-h1', now() - interval '179 days'),
  ('84000000-0000-4000-8000-000000000002', 'shadow-mate', 'sync_failed', '82000000-0000-4000-8000-000000000001', '83000000-0000-4000-8000-000000000001', now() - interval '180 days', 'Asia/Shanghai', '{"error_code":"net"}'::jsonb, 'cleanup-h2', now() - interval '180 days'),
  ('84000000-0000-4000-8000-000000000003', 'shadow-mate', 'sync_failed', '82000000-0000-4000-8000-000000000001', '83000000-0000-4000-8000-000000000001', now() - interval '180 days 1 hour', 'Asia/Shanghai', '{"error_code":"net"}'::jsonb, 'cleanup-h3', now() - interval '180 days 1 hour'),
  ('84000000-0000-4000-8000-000000000004', 'shadow-mate', 'sync_failed', '82000000-0000-4000-8000-000000000001', '83000000-0000-4000-8000-000000000001', now() - interval '200 days', 'Asia/Shanghai', '{"error_code":"net"}'::jsonb, 'cleanup-h4', now() - interval '200 days'),
  ('84000000-0000-4000-8000-000000000005', 'shadow-mate', 'sync_failed', '82000000-0000-4000-8000-000000000001', '83000000-0000-4000-8000-000000000001', now() - interval '40 days', 'Asia/Shanghai', '{"error_code":"net"}'::jsonb, 'cleanup-h5', now() - interval '40 days'),
  ('84000000-0000-4000-8000-000000000006', 'shadow-mate', 'sync_failed', '82000000-0000-4000-8000-000000000001', '83000000-0000-4000-8000-000000000001', now() - interval '20 days', 'Asia/Shanghai', '{"error_code":"net"}'::jsonb, 'cleanup-h6', now() - interval '20 days');
